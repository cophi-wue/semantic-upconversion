...
:::: {.column width="20%"}
::: {.index-brand-rail}
[![](images/university-wuerzburg-logo.png){width="80%"}](https://www.uni-wuerzburg.de)
...
Welcome to the documentation portal for the project "Erschließung und Strukturanalyse der Heftromane der Deutschen Nationalbibliothek" (Semantic Upconversion and Structural Analysis of German Dime Novels of the German National Library).
