...
Analysing the XML and HTML files inside the test data set revealed a lack of standardized semantic markup systems within and across publishing houses.
...
- **Cora and HarperCollins (184 Books):** These publishers use highly inconsistent, divergent visual encodings. Translating these files requires mapping a long tail of volatile CSS classes and inline style definitions.
